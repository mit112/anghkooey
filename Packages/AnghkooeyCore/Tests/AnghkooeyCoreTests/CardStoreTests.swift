...
private func makeInMemoryContainer() throws -> ModelContainer {
    try ModelContainer(
        for: AnghkooeySchemaV1.allModels,
...
struct CardStoreTests {
    ...
    func apply_persistsAcrossStoreReopen() async throws {
        ...
        let container1 = try ModelContainer(for: AnghkooeySchemaV1.allModels, configurations: config)
        ...
        let container2 = try ModelContainer(for: AnghkooeySchemaV1.allModels, configurations: config)
